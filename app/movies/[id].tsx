...
const MovieDetails = () => {
    ...
    return (
        <View className="bg-primary flex-1">
            ...
            <TouchableOpacity className="absolute bottom-5 w-16 h-16 right-0 mx-5 bg-accent rounded-full py-3.5 flex flex-row items-center justify-center z-50" onPress={() => router.push("/")}>
                <Image source={icons.home} className="size-15 " tintColor="#fff" />
            </TouchableOpacity>
